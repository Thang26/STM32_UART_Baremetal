...
#define GPIOA_AFR_SEL(HIGH_LOW, PIN_NUM, PERIPH_SEL)     SET_BIT(GPIOA->AFR[(HIGH_LOW)], (PERIPH_SEL) << ((PIN_NUM - (HIGH_LOW * 8)) * 4))
#define GPIOB_AFR_SEL(HIGH_LOW, PIN_NUM, PERIPH_SEL)     SET_BIT(GPIOB->AFR[(HIGH_LOW)], (PERIPH_SEL) << ((PIN_NUM - (HIGH_LOW * 8)) * 4))
#define GPIOC_AFR_SEL(HIGH_LOW, PIN_NUM, PERIPH_SEL)     SET_BIT(GPIOC->AFR[(HIGH_LOW)], (PERIPH_SEL) << ((PIN_NUM - (HIGH_LOW * 8)) * 4))
